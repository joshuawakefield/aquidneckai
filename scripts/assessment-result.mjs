...
export function assessResponse(input,observation,response,now=Date.now()){
 ...
 if(valid&&!AI_TERM.test(input.text))guarded={...decision,decision:'reject',ai_quote:'',reason:'No explicit AI evidence in the collected title and excerpt. The full article has not been assessed.'};
